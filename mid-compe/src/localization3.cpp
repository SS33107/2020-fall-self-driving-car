...
class localization{
  ...
  private:
    ...
    int count=1;
    string map_path ="$(find localization_309605004)/map/demo22.pcd";
    string csv_path ="$(find localization_309605004)/submit_3.csv";
    string target_frame = "car";
    string source_frame = "nuscenes_lidar";
    ofstream outfile;
...
localization::localization(ros::NodeHandle nh)
{
  ...
  passMy.setFilterLimits (750,1300);
...
{ 
  ...
  if(count<10) {
   passCx.setFilterLimits (-15,30);
   passCy.setFilterLimits (-30, 30);
   passCz.setFilterLimits (2.5, 50);

  }
  else if(count<80) {
   passCx.setFilterLimits (-30,30);
   passCy.setFilterLimits (-30, 30);
   passCz.setFilterLimits (2.5, 50);

  }
   else if(count<155) {
   passCx.setFilterLimits (-15,70);
   passCy.setFilterLimits (-0, 30);
   passCz.setFilterLimits (2.5, 50);
  }
   else if(count<230) {
   passCx.setFilterLimits (0,70);
   passCy.setFilterLimits (-30, 30);
   passCz.setFilterLimits (2.5, 50);
  }
  else{
   passCx.setFilterLimits (-50,80);
   passCy.setFilterLimits (-30, 70);
   passCz.setFilterLimits (3, 50);
  }
